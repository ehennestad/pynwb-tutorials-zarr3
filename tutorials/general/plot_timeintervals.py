...
timeintervals_path = "example_timeintervals_file.nwb.zarr"

# write the store
with NWBZarrIO(timeintervals_path, "w", force_overwrite=True) as io:
    io.write(nwbfile)
# read the store
with NWBZarrIO(timeintervals_path, "r") as io:
    nwbfile_in = io.read()
