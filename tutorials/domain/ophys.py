...
# I/O operations are carried out using :py:class:`~hdmf_zarr.nwb.NWBZarrIO`.

ophys_path = "ophys_tutorial.nwb.zarr"
with NWBZarrIO(ophys_path, "w", force_overwrite=True) as io:
    io.write(nwbfile)
...
with NWBZarrIO(ophys_path, "r") as io:
