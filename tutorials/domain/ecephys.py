...
ecephys_path = "ecephys_tutorial.nwb.zarr"
with NWBZarrIO(ecephys_path, "w", force_overwrite=True) as io:
    io.write(nwbfile)

####################
# For more details on Zarr I/O, see the :ref:`zarr_io` tutorial.
...
with NWBZarrIO(ecephys_path, "r") as io:
