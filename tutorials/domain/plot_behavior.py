...
behavior_path = "behavioral_tutorial.nwb.zarr"
with NWBZarrIO(behavior_path, "w", force_overwrite=True) as io:
    io.write(nwbfile)
...
# ---------------------------------------
#
# To read the NWB store we just wrote, use another :py:class:`~hdmf_zarr.nwb.NWBZarrIO` object,
...
with NWBZarrIO(behavior_path, "r") as io:
