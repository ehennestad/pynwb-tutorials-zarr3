...
# Write our test file
ex_testpath = "ex_test_icephys_file.nwb.zarr"
with NWBZarrIO(ex_testpath, "w", force_overwrite=True) as io:
    io.write(ex_nwbfile)

# Read the data back in
with NWBZarrIO(ex_testpath, "r") as io:
    infile = io.read()
...
# Write our test file
testpath = "test_icephys_file.nwb.zarr"
with NWBZarrIO(testpath, "w", force_overwrite=True) as io:
    io.write(nwbfile)

# Read the data back in
with NWBZarrIO(testpath, "r") as io:
    infile = io.read()
